...
var calculator = new Vue({
    ...
    methods: {
      ...
      getResults: function () {
        ...
        console.log(urbanDef_low)
        console.log(urbanDef_high)
        ...
        // if (adjustedIncome < urbanDef_low || adjustedIncome > urbanDef_high) {
        //     console.log("not middle class");
        //     plotLineClass = "not-middle-line"
        // } else if (adjustedIncome < urbanDef_low || adjustedIncome > urbanDef_high) {
        // } else {
        //     plotLineClass = "middle-line"
        // }
